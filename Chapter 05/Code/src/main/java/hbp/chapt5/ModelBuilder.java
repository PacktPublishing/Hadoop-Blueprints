...
public class ModelBuilder {
	...
	public void buildModel() {
		totalRows = freqYesHmp.get("yes") + freqNoHmp.get("no");
		modelNoHmp = calculateProbabilities(freqNoHmp, "no");
		modelYesHmp = calculateProbabilities(freqYesHmp, "yes");
	}

	public HashMap<String, Double> calculateProbabilities(HashMap<String, Integer> frequency, String target) {
